  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-600 mt-1">View and filter patient consultations across the hospital.</p>
      </div>

      <div className="bg-white p-4 rounded-lg border border-gray-200 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 items-center">
        ...
        <button onClick={clearFilters} className="text-sm text-gray-600 hover:text-purple-600 flex items-center justify-center space-x-2">
            <X size={16} />
