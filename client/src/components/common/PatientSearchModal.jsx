              ...
              {!isLoading && debouncedPhone.length >= 3 && (
                <div className="space-y-3">
                   <button
                    ...
                    className="w-full flex items-center space-x-3 p-4 border-2 border-dashed rounded-lg hover:border-purple-400 hover:bg-purple-50"
                  >
                    <Plus className="h-5 w-5 text-purple-600" />
                    <div className="text-left">
                      <p className="font-medium text-purple-600">Add New Patient with phone</p>
